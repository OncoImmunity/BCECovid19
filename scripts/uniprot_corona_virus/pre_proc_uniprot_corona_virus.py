"""
Pre-processing for UNIPROT CORONA VIRUS

It will use the fasta file uniprot_coronavirus.fasta and process it in order to be able to run in the predictor.
...
if __name__ == '__main__':
    ...
    # create logger file:
    # ----------
    logger_file_name = "uniprot_corona_virus_pre_proc"
    create_logging_file(logger_file_name=logger_file_name, save_path=os.path.dirname(__file__))
    logger = logging.getLogger(__name__)
    logger.info("=================================================")
    logger.info("===== Pre-processing uniprot_corona_virus =======")
    logger.info("=================================================")
    # ----------
    # run the pre-processing:
    # ----------
    tot_parsed_seq, tot_seq_filtered, junk_id = pre_proc(data_path=paths.get_uniprot_coronavirus_19_path(),
                                                         file_name="uniprot_coronavirus.fasta",
                                                         junk_name="uniprot_coronavirus")
